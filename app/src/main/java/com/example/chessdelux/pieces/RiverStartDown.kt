...
class RiverStartDown(white: Boolean) : Piece(white, PieceType.RIVER_START_DOWN, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_start_down_white else R.drawable.river_start_down_black
