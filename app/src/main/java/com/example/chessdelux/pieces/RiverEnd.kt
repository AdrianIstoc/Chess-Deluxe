...
class RiverEnd(white: Boolean) : Piece(white, PieceType.RIVER_END, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_end_white else R.drawable.river_end_black
