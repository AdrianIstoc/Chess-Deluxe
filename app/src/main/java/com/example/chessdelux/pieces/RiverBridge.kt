...
class RiverBridge(white: Boolean) : Piece(white, PieceType.RIVER_BRIDGE, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_bridge_white else R.drawable.river_bridge_black
