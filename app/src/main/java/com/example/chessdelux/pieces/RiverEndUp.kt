...
class RiverEndUp(white: Boolean) : Piece(white, PieceType.RIVER_END_UP, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_end_up_white else R.drawable.river_end_up_black
