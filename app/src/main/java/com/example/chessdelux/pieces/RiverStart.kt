...
class RiverStart(white: Boolean) : Piece(white, PieceType.RIVER_START, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_start_white else R.drawable.river_start_black
