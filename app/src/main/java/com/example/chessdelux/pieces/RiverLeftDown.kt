...
class RiverLeftDown(white: Boolean) : Piece(white, PieceType.RIVER_LEFT_DOWN, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_left_down_white else R.drawable.river_left_down_black
