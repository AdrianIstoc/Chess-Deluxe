...
class RiverRightDown(white: Boolean) : Piece(white, PieceType.RIVER_RIGHT_DOWN, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_right_down_white else R.drawable.river_right_down_black
