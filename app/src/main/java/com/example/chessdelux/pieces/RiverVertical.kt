...
class RiverVertical(white: Boolean) : Piece(white, PieceType.RIVER_VERTICAL, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_vertical_white else R.drawable.river_vertical_black
