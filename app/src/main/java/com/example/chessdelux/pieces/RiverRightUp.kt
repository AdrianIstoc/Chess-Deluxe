...
class RiverRightUp(white: Boolean) : Piece(white, PieceType.RIVER_RIGHT_UP, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_right_up_white else R.drawable.river_right_up_black
