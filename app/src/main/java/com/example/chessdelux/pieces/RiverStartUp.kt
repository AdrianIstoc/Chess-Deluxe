...
class RiverStartUp(white: Boolean) : Piece(white, PieceType.RIVER_START_UP, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_start_up_white else R.drawable.river_start_up_black
