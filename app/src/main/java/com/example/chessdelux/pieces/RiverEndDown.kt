...
class RiverEndDown(white: Boolean): Piece(white, PieceType.RIVER_END_DOWN, 1, Int.MAX_VALUE) {
    override var imageResource: Int? = if (white) R.drawable.river_end_down_white else R.drawable.river_end_down_black
